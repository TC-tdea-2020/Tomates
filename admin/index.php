     ...
     <center>
        <form style="padding-top:10%;" method="post" action="">
          <div class="centrar_login">
            ...
            <div class="form-group">
              <input type="button" onclick = "location='../index.php'" name="volver atrás" value="volver atrás">
...
<head>
  ...
  <title>Admin Tomates checho</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Tomates</b>Checho</span>
    </a>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h1>Agregar <p><h1>Producto</h1></h1>
            ...
            <a href="./?p=agregar_producto" class="small-box-footer">Nuevo Producto <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h1>Manejar <p><h1>Tracking</h1></h1>
            ...
            <a href="./?p=manejar_tracking" class="small-box-footer">Ver Serguir<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         ...
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="https://web.whatsapp.com/" target="_blank" class="small-box-footer">Ir a Whatsapp<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h1>Agregar<p><h1>Categoria</h1></h1>
            ...
            <a href="./?p=agregar_categoria"class="small-box-footer">ver Categorias<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="./?p=pagos" class="small-box-footer">Ver Pagos<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020<a href="http://almsaeedstudio.com">Tecnologico de Antioquia</a>.</strong> All rights
    reserved.
  </footer>
