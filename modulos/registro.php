...
if(isset($enviar)){
	...
	$mysqli->query("INSERT INTO clientes (username,password,name,email) VALUES ('$username','$password','$nombre', '$email')");
		...
		<form method="post" action="">
			<div class="centrar_login">
				...
				<div class="form-group">
					<input type="text" autocomplete="off" class="form-control" placeholder="Correo" name="email"/>
				</div>
				<div class="form-group">
